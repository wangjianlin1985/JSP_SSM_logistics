...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a href="<%=basePath %>index.jsp" class="navbar-brand">物流网</a>
        </div>
        <!--小屏幕导航按钮和logo-->
        <!--导航-->
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-left">
                ...
                <!-- 
                 ...
                 <li><a href="<%=basePath %>OrderState/frontlist">订单状态</a></li> -->
                <li><a href="<%=basePath %>OrderInfo/frontlist">用户订单查询</a></li> 
                <li><a href="<%=basePath %>Car/frontlist">运输车辆查询</a></li>
                <li><a href="<%=basePath %>CarRoute/frontlist">车辆调度查询</a></li>
                <li><a href="<%=basePath %>OrderTrans/frontlist">订单运输</a></li>
                <li><a href="<%=basePath %>News/frontlist">新闻动态</a></li>
             ...
             <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dLabel">
                        ...
                        <li><a href="<%=basePath %>OrderInfo/orderInfo_frontUserAdd.jsp"><span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;我要寄货</a></li>
                        <li><a href="<%=basePath %>OrderInfo/userFrontlist"><span class="glyphicon glyphicon-cog"></span>&nbsp;&nbsp;我的物流订单</a></li>
