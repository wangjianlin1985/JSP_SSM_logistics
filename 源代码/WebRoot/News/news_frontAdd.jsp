		...
		<div class="col-md-12 wow fadeInUp" data-wow-duration="0.5s">
			<div>
				...
				<ul class="nav nav-tabs" role="tablist">
			    	<li role="presentation" ><a href="<%=basePath %>News/frontlist">新闻动态列表</a></li>
			    	<li role="presentation" class="active"><a href="#newsAdd" aria-controls="newsAdd" role="tab" data-toggle="tab">添加新闻动态</a></li>
				</ul>
				<!-- Tab panes -->
				<div class="tab-content">
				    ...
				    <div role="tabpanel" class="tab-pane active" id="newsAdd"> 
						  ...
						  <div class="form-group">
						  	 <label for="news_title" class="col-md-2 text-right">标题:</label>
						  	 <div class="col-md-8">
							    <input type="text" id="news_title" name="news.title" class="form-control" placeholder="请输入标题">
							 </div>
						  </div>
						  <div class="form-group">
						  	 <label for="news_content" class="col-md-2 text-right">公告内容:</label>
						  	 <div class="col-md-8">
...
<script>
//实例化编辑器
var news_content_editor = UE.getEditor('news_content'); //公告内容编辑器
