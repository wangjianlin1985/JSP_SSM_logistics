...
public class OrderStateService {
    ...
    /*根据主键获取订单状态记录*/
    public OrderState getOrderState(int orderStateId) throws Exception  {
        OrderState orderState = orderStateMapper.getOrderState(orderStateId);
        return orderState;
    }
    ...
    public void deleteOrderState (int orderStateId) throws Exception {
        orderStateMapper.deleteOrderState(orderStateId);
    }

    /*删除多条订单状态信息*/
    public int deleteOrderStates (String orderStateIds) throws Exception {
    	String _orderStateIds[] = orderStateIds.split(",");
    	for(String _orderStateId: _orderStateIds) {
    		orderStateMapper.deleteOrderState(Integer.parseInt(_orderStateId));
    	}
    	return _orderStateIds.length;
    }
}
